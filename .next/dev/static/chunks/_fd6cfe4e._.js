...
"[project]/components/common/SupportWidget.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 */ const SupportWidget = ()=>{
    ...
    const pathname = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"])();
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SupportWidget.useEffect": ()=>{
            // Don't load the widget on the home page
            if (pathname === '/') {
                return;
            }
            // Check if script already exists to prevent duplicate loads
            const existingScript = document.querySelector('script[src*="support.ccaas.intarvas.com"]');
            if (existingScript) {
...
_s(SupportWidget, "V/ldUoOTYUs0Cb2F6bbxKSn7KxI=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["usePathname"]
    ];
});
_c = SupportWidget;
const __TURBOPACK__default__export__ = SupportWidget;
var _c;
...
//# sourceMappingURL=_fd6cfe4e._.js.map