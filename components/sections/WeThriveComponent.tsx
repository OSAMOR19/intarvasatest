...
const ServicesShowcase = () => {
  ...
  const services = [
    {
      icon: <img src="/networkicon.svg" alt="Network" className="w-8 h-8" />,
      title: "IntarvAS PBX",
      description:
    ...
    {
      icon: <img src="/linkicon.svg" alt="All in one solution" className="w-8 h-8" />,
    ...
    {
      icon: <img src="/vanityiconn.svg" alt="Vanity numbers" className="w-8 h-8" />,
    ...
    {
      icon: <img src="/bulkmessaging.svg" alt="Bulk Messaging" className="w-8 h-8" />,
